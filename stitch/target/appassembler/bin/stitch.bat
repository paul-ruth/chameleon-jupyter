...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="stitch" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.renci.chameleon.jupyter.stitch.App %CMD_LINE_ARGS%
